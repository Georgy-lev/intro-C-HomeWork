...
double[] lineData1 = InputLineData (LINE2);
...
double [] InputLineDate(int numberOfLine)
{
    ...
    lineDate[COEFFICIENT]= Prompt($"Введите коэффициен для {numberOfLine} прямой >");
    lineDate[COEFFICIENT]= Prompt($"Введите константу для {numberOfLine} прямой >");
    return lineData;
}
